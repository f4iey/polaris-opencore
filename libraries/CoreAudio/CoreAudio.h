...
class CoreAudio: public Machine {
 ...
 private:
  ...
  AudioPlaySdRaw soundPlaySdRaw;
  AudioPlaySdRaw soundPlaySdFXRaw;
  AudioPlaySdRaw soundPlaySdSmoothSwingARaw;
  AudioPlaySdRaw soundPlaySdSmoothSwingBRaw;
  AudioMixer4 mainMixer;
  AudioOutputAnalog outputDac;
  AudioConnection* patchSineMixer = nullptr;
  AudioConnection* patchSdMixer = nullptr;
  AudioConnection* patchSdFXMixer = nullptr;
  AudioConnection* patchSdSmoothSwingAMixer = nullptr;
  AudioConnection* patchSdSmoothSwingBMixer = nullptr;
